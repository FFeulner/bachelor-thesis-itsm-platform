...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC4AE00);
  late Color secondary = const Color(0xFF8A434C);
  ...
  late Color customColor1 = const Color(0xFF3A3A3A);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA18B00);
  late Color secondary = const Color(0xFF6B2B39);
  late Color tertiary = const Color(0xFFA9A9A9);
  late Color alternate = const Color(0xFFFF9F00);
  late Color primaryText = const Color(0xFFFFFFFF);
